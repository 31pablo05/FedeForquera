...
const Card6 = () => {
  ...
  const images = [
    "/assets/images/Vodcast.webp/vod1.webp",
    "/assets/images/Vodcast.webp/vod2.webp",
    "/assets/images/Vodcast.webp/vod3.webp",
    "/assets/images/Vodcast.webp/vod4.webp",
    "/assets/images/Vodcast.webp/vod5.webp",
    "/assets/images/Vodcast.webp/vod6.webp",
    "/assets/images/Vodcast.webp/vod7.webp"
  ];
      ...
      <div className="relative overflow-hidden rounded-2xl bg-slate-800">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
          ...
          <p className="text-gray-300 mb-4 opacity-90">
            Producción audiovisual para contenido digital
          </p>
        ...
        >
          <div className="relative max-w-[95vw] max-h-[95vh]" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 rounded-b-xl">
              <p className="text-white text-lg font-medium">Vodcast Producción</p>
