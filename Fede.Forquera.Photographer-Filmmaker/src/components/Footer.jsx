          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                <svg className="w-5 h-5 mr-3 text-[#379299] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center">
                <svg className="w-5 h-5 mr-3 text-[#379299] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
