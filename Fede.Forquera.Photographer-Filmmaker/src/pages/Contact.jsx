        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
            ...
            <section className="relative py-20 px-4">
                ...
                <div className="relative z-10 max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <h1 
                            className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white via-[#379299] to-cyan-400"
                            data-aos="fade-up"
                        >
                            Hablemos
                        </h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full pl-12 pr-4 py-4 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-[#379299] focus:ring-2 focus:ring-[#379299]/50 transition-all duration-300"
                                    />
                                </div>
                                <div className="relative">
                                ...
                                <div className="relative">
                                    ...
                                    <textarea
                                        ...
                                        required
                                        rows="5"
                                        className="w-full pl-12 pr-4 py-4 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-[#379299] focus:ring-2 focus:ring-[#379299]/50 transition-all duration-300 resize-none"
                                    ></textarea>
                                </div>
                                <button 
                                    type="submit" 
                                    disabled={isLoading}
                                    className="w-full py-4 bg-gradient-to-r from-[#379299] to-cyan-400 text-white rounded-lg font-semibold flex items-center justify-center hover:shadow-lg hover:shadow-[#379299]/30 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {isLoading ? (
                        ...
                        >
                            ...
                            {contactMethods.map((method, index) => (
                                <div
                                    key={index}
                                    className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 cursor-pointer transform hover:scale-105"
                                    onClick={method.action}
                                    data-aos="fade-up"
                                    data-aos-delay={index * 100}
                                >
                                    <div className="flex items-center space-x-4">
                                        <div className={`p-4 rounded-full bg-gradient-to-r ${method.color} ${method.hoverColor} transition-all duration-300`}>
                            ...
                            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
                                <h3 className="text-white font-semibold text-lg mb-4">Sígueme en redes</h3>
                            ...
                            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
                                ...
                                <div className="space-y-3 text-gray-300">
                                    <div className="flex items-center space-x-3">
                                        <FaMapMarkerAlt className="text-[#379299]" />
                                        <span>Buenos Aires, Argentina</span>
                                    </div>
                                    <div className="flex items-center space-x-3">
                                        <FaUser className="text-[#379299]" />
            ...
            {showModal && (
                <div className="fixed inset-0 flex items-center justify-center bg-black/80 backdrop-blur-sm z-50 p-4">
                    <div 
                        className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center max-w-md w-full shadow-2xl"
                        data-aos="zoom-in"
                    >
                        {isSuccess ? (
                            <FaCheckCircle className="text-green-400 text-5xl mb-4 mx-auto" />
                        ) : (
                            <FaTimesCircle className="text-red-400 text-5xl mb-4 mx-auto" />
                        )}
                        <p className={`text-lg mb-6 ${isSuccess ? "text-green-300" : "text-red-300"}`}>
                            {statusMessage}
                        </p>
                        <button 
                            onClick={handleCloseModal} 
                            className="px-6 py-3 bg-gradient-to-r from-[#379299] to-cyan-400 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-[#379299]/30 transition-all duration-300 transform hover:scale-105"
                        >
                            Cerrar
                        </button>
                    </div>
